...
const navigation = [
  { name: 'Central Av', href: '#', current: true },
  { name: 'San Nicolas', href: '#', current: false },
]
                    ...
                    {navigation.map((item) => (
                      <a
                        ...
                        className={classNames(
                          item.current ? 'bg-hueso-800  text-white ' : 'text-gray-300 hover:bg-hueso-800 hover:text-white',
